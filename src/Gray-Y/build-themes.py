...
if __name__ == '__main__':
    ...
    for variation in VARIATIONS:
        ...
        if variation == "Gray-Y":
            ...
            os.system("cp cinnamon/gray-y-thumbnail.png %s" % os.path.join(version_folder, "thumbnail.png"))
        ...
        elif variation == "Gray-Y-Darker":
            print("    Building Gray-Y-Darker")
        ...
        elif variation == "Gray-Y-Dark":
            print("    Building Gray-Y-Dark")
            ...
            os.system("cp cinnamon/gray-y-dark-thumbnail.png %s" % os.path.join(version_folder, "thumbnail.png"))
